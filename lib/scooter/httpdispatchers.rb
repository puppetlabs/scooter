...
module Scooter
  ...
  module HttpDispatchers
    ...
    # == Quick-start guide
    # === Quick example creating an api dispatcher and ui dispatcher
    #
    #  require 'scooter/httpdispatchers'
    #
    #  api = ConsoleDispatcher.new(dashboard)
    #
    #  #creates a new user and returns a new ConsoleDispatcher
    #  new_user = api.create_local_user('login' => 'new_guy')
    #  new_user.signin
    #
    #  #this will trigger the middleware error handler, because you cannot
    #  #create two users with the same login
    #  api.create_local_user('login' => 'new_guy')
    #
    #  #this will return the new_guy's data
    #  api.get_console_dispatcher_data(new_guy)
    #
    #  api.delete_local_console_dispatcher(new_user)
    #
    #  #the same method will now return nil because new_user is deleted
    #  api.get_console_dispatcher_data(new_guy)
    class ConsoleDispatcher
      ...
      #   it is assumed dispatching object will send traffic directly to the
      #   APIs.
